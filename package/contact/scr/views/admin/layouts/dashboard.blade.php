...
<head>
    ...
    <meta name="description" content="Muain">
    <meta name="author" content="Spruko Technologies Private Limited">
    <meta name="keywords"
        content="admin,admin dashboard,admin panel,admin template,bootstrap,clean,dashboard,flat,jquery,modern,responsive,premium admin templates,responsive admin,ui,ui kit.">

    <!-- FAVICON -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/images/brand/moeen3.png') }}" />
...
<body class="app sidebar-mini ltr light-mode">
                    ...
                    <div class="predefined_styles">
                        <div class="swichermainleft text-center">
                            <div class="p-3 d-grid gap-2">
                                <a href="{{ route('user.complaint') }}" class="btn ripple btn-primary mt-0">View
                                    Demo</a>
                            ...
                            <div class="skin-body switch_section">
                                ...
                                <div class="switch-toggle d-flex mt-2">
                                    <a class="bg-img1" href="javascript:void(0);" onclick="bgImage(this)"><img
                                            src="{{ asset('assets/images/media/bg-img1.jpg') }}" alt="Bg-Image"
                                            id="bgimage1"></a>
                                    <a class="bg-img2" href="javascript:void(0);" onclick="bgImage(this)"><img
                                            src="{{ asset('assets/images/media/bg-img2.jpg') }}" alt="Bg-Image"
                                            id="bgimage2"></a>
                                    <a class="bg-img3" href="javascript:void(0);" onclick="bgImage(this)"><img
                                            src="{{ asset('assets/images/media/bg-img3.jpg') }}" alt="Bg-Image"
                                            id="bgimage3"></a>
                                    <a class="bg-img4" href="javascript:void(0);" onclick="bgImage(this)"><img
                                            src="{{ asset('assets/images/media/bg-img4.jpg') }}" alt="Bg-Image"
                                            id="bgimage4"></a>
                                </div>
                            </div>
                        </div>
    ...
    <div id="global-loader">
        <img src="{{ asset('assets/images/brand/moeen3.png') }}" class="loader-img" alt="Loader">
    </div>
    <!-- /GLOBAL-LOADER -->
                ...
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        ...
                        <a class="logo-horizontal " href="index.html">
                            <img src="{{ asset('assets/images/brand/moeen3.png') }}"
                                    ...
                                    <div class="d-flex order-lg-2">
                                        ...
                                        <div class="dropdown d-flex profile-1">
                                            <a href="javascript:void(0)" data-bs-toggle="dropdown"
                                                ...
                                                <img id="avatar-image"
                                                    src="{{ asset(Auth::user()->avatar ?: 'assets/images/users/no-emp-image.png') }}"
                                                    alt="profile-user"
                ...
                <div class="app-sidebar">
                    <div class="side-header">
                        <a class="header-brand1" href="">
                            <img src="{{ asset('assets/images/brand/moeen1.png') }}"
                                class="header-brand-img desktop-logo" alt="logo">
                            <img src="{{ asset('assets/images/brand/moeen3.png') }}"
                                class="header-brand-img toggle-logo" alt="logo">
                            <img src="{{ asset('assets/images/brand/moeen2.png') }}"
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <ul class="slide-menu open">
                                <li class="is-expanded"><a href="{{ route('ticket') }}" class="slide-item active">
                                        All </a></li>
                                <li><a href="{{ route('open_ticket') }}" class="slide-item"> Open </a></li>
                                <li><a href="{{ route('close_ticket') }}" class="slide-item"> Close </a></li>

                            </ul>

                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide"
                                    href="{{ route('user_control') }}">
                                    <i class="side-menu__icon fa fa-address-card"></i><span
                                        class="side-menu__label">User Control
                                    </span></a>
                            </li>

                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide"
                                    href="{{ route('rols_control') }}">
                                    <i class="side-menu__icon mdi mdi-account-alert mdi-size-same-as-user"></i>
                                    <span class="side-menu__label">Roles Control</span>
                                </a>
                            </li>

                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide"
                                    href="{{ route('client_control') }}">
                                    <i class="fa fa-users side-menu__icon" data-bs-toggle="tooltip"
                                        title="fa fa-users" aria-label="fa fa-users"></i>
                                    <span class="side-menu__label">Client Control</span>
                                </a>
                            </li>
        ...
        <div class="container">
            <div class="row align-items-center flex-row-reverse">
                <div class="col-md-12 col-sm-12 text-center">
                    Copyright © <span id="year"></span> <a href="javascript:void(0)">Sahalat LLC</a>. Designed
                    with <span class="fa fa-heart text-danger"></span> by <a href="javascript:void(0)"> MASS </a>
                    All rights reserved.
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        @if (Session::has('message2'))
            swal.fire("{{ Session::get('title') }}", "{{ Session::get('message2') }}",
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response == 1) {
                        ...
                        $("#darkModeBtn").attr('onclick', 'DarkMode(0)')
                    } else {
                        $('body').removeClass('dark-mode');
                        $('body').addClass('light-mode');
                        $("#darkModeBtn").attr('onclick', 'DarkMode(1)')
                    }
                }
            });
        }
